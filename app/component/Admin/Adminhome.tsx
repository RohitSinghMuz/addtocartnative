...
const styles = StyleSheet.create({
  ...
  CategoriesTextStyle: {
    ...
    paddingTop: Platform.OS === 'android' ? getHeigth(0.3) : getHeigth(4),
  ...
  listItemGapStyle: {
    marginLeft: getHeigth(1.5),
  },
  addButtonElement: {
    width: getWidth(10),
    height: getHeigth(5),
    borderRadius: getHeigth(2),
    alignSelf: 'center',
  ...
  plusViewStyle: {
    ...
    width: getWidth(11),
    height: getHeigth(5),
    paddingVertical: getHeigth(1.5),
    alignSelf: 'center',
    alignItems: 'center',
    textAlign: 'center',
    borderRadius: getHeigth(4.5),
  },
  uploadButtonStyle: {
    padding: getHeigth(1.4),
    color: '#19212699',
    marginLeft: getHeigth(1.3),
    fontFamily: 'Urbanist',
    fontWeight: '500',
    fontSize: getFontSize(4),
    textAlign: 'center',
  ...
  selectedItemStyle: {
    width: getWidth(48),
    marginHorizontal: getHeigth(0.3),
  },
  imageStyle: {
    marginTop: getHeigth(1.4),
    width: getWidth(43),
    height: getHeigth(19.2),
    borderTopRightRadius: getHeigth(3.2),
    borderTopLeftRadius: getHeigth(3.2),
  },
  imageUploadStyle: {
    marginTop: getHeigth(0),
    width: getWidth(85),
    height: getHeigth(25),
    borderRadius: getHeigth(3.2),
    borderWidth: getHeigth(0.3),
    borderColor: '#36CC55',
  },
  centeredView: {
    height: getWidth(100),
  ...
  modalView: {
    margin: getHeigth(1.4),
    backgroundColor: 'white',
    borderRadius: getHeigth(3.4),
    padding: getHeigth(2),
    alignItems: 'center',
    shadowColor: '#000',
    shadowOffset: {
      width: 0,
      height: getHeigth(0.4),
    },
    shadowOpacity: 0.25,
    shadowRadius: 4,
    elevation: 5,
  ...
  handleChoosePhotoStyle: {
    ...
    alignSelf: 'center',
    justifyContent: 'center',
    borderWidth: getHeigth(0.4),
    borderColor: '#36CC55',
    borderRadius: getHeigth(3),
  },
  uploadImgStyle: {
    width: getWidth(10),
    height: getHeigth(5),
  ...
  addNewStyle: {
    ...
    paddingVertical: getHeigth(0.4),
    marginTop: getHeigth(-0.6),
    marginHorizontal: getHeigth(2),
    overflow: 'hidden',
    zIndex: -2,
    color: '#192126',
    fontFamily: 'Lato',
    fontWeight: Platform.OS === 'android' ? '700' : '600',
    lineHeight: getHeigth(3.8),
    fontSize: getFontSize(3.5),
  },
  addNewViewStyle: {
    backgroundColor: '#D4DAE3',
    height: getHeigth(3.9),
    width: getWidth(35),
    paddingVertical: getHeigth(0.2),
    marginTop: getHeigth(-2),
    marginHorizontal: getHeigth(1.6),
    borderBottomLeftRadius: getHeigth(5.5),
    borderBottomRightRadius: getHeigth(3.5),
    overflow: 'hidden',
    zIndex: -2,
    lineHeight: getHeigth(3.8),
    fontSize: getFontSize(4),
  ...
  brandNameViewStyle: {
    ...
    zIndex: -2,
    fontSize: getFontSize(4),
    borderBottomLeftRadius: getHeigth(3.4),
    borderBottomRightRadius: getHeigth(3.4),
  },
  editDeleteViewStyle: {
    display: 'flex',
    flexDirection: 'row',
    ...
    marginHorizontal: getHeigth(2),
    marginVertical: getHeigth(1.4),
  },
  buttonDeleteStyle: {
    backgroundColor: '#EB001BE0',
    borderRadius: getHeigth(1.4),
    paddingHorizontal: getHeigth(1.5),
    paddingVertical: getHeigth(1.2),
    alignSelf: 'center',
    width: getWidth(12),
    height: getHeigth(5),
    marginHorizontal: getHeigth(1.2),
  },
  buttonEditStyle: {
    backgroundColor: '#36CC55',
    alignSelf: 'center',
    ...
    paddingHorizontal: getHeigth(1.5),
    paddingVertical: getHeigth(1.2),
    marginHorizontal: getHeigth(1.4),
  },
  buttonTextStyle: {
    width: getWidth(6),
  ...
  flatlistViewStyle: {
    ...
    borderTopRightRadius: getHeigth(3.4),
    borderTopLeftRadius: getHeigth(3.4),
    paddingHorizontal: getHeigth(1.7),
    marginTop: getHeigth(-3.3),
    flex: 1,
  },
  parentFlatlistViewStyle: {
    height: getHeigth(5.5),
    width: getWidth(90),
    borderTopRightRadius: getHeigth(10),
    borderTopLeftRadius: getHeigth(10),
    marginTop: getHeigth(0.1),
    marginHorizontal: getHeigth(2.4),
    paddingHorizontal: getHeigth(3.4),
  },
  ...
  inputContainer: {
    ...
    width: getWidth(85),
    height: getHeigth(10.4),
    marginVertical: getHeigth(1.8),
  },
  focusedInputContainer: {
    borderColor: 'rgba(25, 33, 38, 0.4)',
    borderWidth: 1,
    borderRadius: getHeigth(1.8),
    width: getWidth(85),
    height: getHeigth(10.3),
    marginVertical: getHeigth(1.8),
  },
  labelTextStyle: {
    height: getHeigth(2.8),
    top: getHeigth(3.8),
    left: getHeigth(2.8),
    fontSize: getFontSize(4),
    fontFamily: 'Lato',
